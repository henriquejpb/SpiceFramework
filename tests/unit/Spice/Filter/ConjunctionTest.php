...
class ConjunctionTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->composite = new \Spice\Filter\Conjunction();
    }

    public function assertPreConditions() {
        $this->assertInstanceOf('\\Spice\\Filter\\Conjunction', $this->composite);
    }
    ...
    /**
     * @tesdox O retorno de `accept()` da disjunção contendo duas folhas, sendo que a primeira retorna `true` e a segunda, `false`, será `false`.
     * @test
     */
    ...
    /**
     * @tesdox O retorno de `accept()` da disjunção contendo duas folhas, sendo que a primeira retorna `false` e a segunda, `true`, será `false`.
     * @test
     */
    ...
    /**
     * @tesdox O retorno de `accept()` da disjunção contendo X > 2 folhas, onde todas, exceto uma, retornam `true` será `false`.
     * @test
     */
